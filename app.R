    ...
    fluidRow(
      column(8,
        ...
        p(span("Dunk", style = "color:#4A708B; font-weight:bold;"),
          ...
          "a commoner armorer / fellow hedge knights / a royal prince. ",
  ...
  tabPanel("Centrality",
    sidebarLayout(
      sidebarPanel(width = 3,
        ...
        hr(),
        helpText(strong("In-Degree:"),
          " how often others speak to this character."),
        br(),
        helpText(strong("Out-Degree:"),
          " how often this character initiates speech."),
        br(),
        helpText(strong("Betweenness:"),
          " how often this character sits between others on the shortest path."),
        br(),
        helpText(strong("Constraint:"),
          " how closed-off a character's connections are. Lower = bridges more separate groups.")
      ),
      mainPanel(width = 9,
